...
def create_app(test_config=None):
    ...
    """
  @TODO: Set up CORS. Allow '*' for origins. Delete
  the sample route after completing the TODOs
  """
  ...
  """
    ...
    def get_questions():
        ...
        questions = (
            Question.query.limit(QUESTIONS_PER_PAGE)
            ...
            return jsonify(
                {
                    ...
                    "currentCategory": Category.query.filter_by(id=category_id)
                    .all()[0]
                    .format()["id"],
                }
            )
  ...
  """
    ...
    def play_quiz():
        ...
        try:
            ...
            next_question = (
                Question.query.filter_by(id=list(available_questions_ids)[0])
                .all()[0]
                .format()
            )
